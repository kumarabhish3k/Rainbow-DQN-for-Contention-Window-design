...
// 
    ...
    std::string prefix1 = "./Dataset/20Node/node1TxPackets";
    std::string prefix2 = "./Dataset/20Node/node1RxPackets";
    std::string prefix3 = "./Dataset/20Node/otherRxPackets";
